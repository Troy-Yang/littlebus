...
/***/ (function(module, exports) {
	...
	angular.module('opentok-meet').factory('RoomService', ['$http', 'baseURL', '$window', 'room',
	  function ($http, baseURL, $window, room) {
	    var doCall = function (url, type, data) {
	    ...
	    return {
	      ...
	      startArchiving: function (sessionId, options) {
	        var url = baseURL + '/archive/start/' + sessionId;
	        return doCall(url, 'post', {archiveOptions: options})
	      },
	      stopArchiving: function(archiveId) {
	        var url = baseURL + '/archive/stop/' + archiveId;
	        return doCall(url, 'get');
	      },
	      startBroadcasting: function(sessionId, options) {
	        var url = baseURL + '/broadcast/start/' + sessionId;
	        return doCall(url, 'post');
	      },
	      stopBroadcasting: function(broadcastId) {
	        var url = baseURL + '/broadcast/stop/' + broadcastId;
	        return doCall(url, 'get');
	      }
	    };
	  }
